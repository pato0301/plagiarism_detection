...
if __name__ == '__main__':
    ...
    print(f'args.input_features: {args.input_features}')
    print(f'args.hidden_dim: {args.hidden_dim}')
    print(f'args.output_dim: {args.output_dim}')
